 ...
 * @property strArea The area or region the meal is from.
 ...
 * @property strMeasure1 The measure of the first ingredient.
 * @property strMeasure10 The measure of the tenth ingredient.
 * @property strMeasure11 The measure of the eleventh ingredient.
 * @property strMeasure12 The measure of the twelfth ingredient.
 * @property strMeasure13 The measure of the thirteenth ingredient.
 * @property strMeasure14 The measure of the fourteenth ingredient.
 * @property strMeasure15 The measure of the fifteenth ingredient.
 * @property strMeasure16 The measure of the sixteenth ingredient.
 * @property strMeasure17 The measure of the seventeenth ingredient.
 * @property strMeasure18 The measure of the eighteenth ingredient.
 * @property strMeasure19 The measure of the nineteenth ingredient.
 * @property strMeasure2 The measure of the second ingredient.
 * @property strMeasure20 The measure of the twentieth ingredient.
 * @property strMeasure3 The measure of the third ingredient.
 * @property strMeasure4 The measure of the fourth ingredient.
 * @property strMeasure5 The measure of the fifth ingredient.
 * @property strMeasure6 The measure of the sixth ingredient.
 * @property strMeasure7 The measure of the seventh ingredient.
 * @property strMeasure8 The measure of the eighth ingredient.
 * @property strMeasure9 The measure of the ninth ingredient.
 * @property strSource The source of the meal recipe.
 * @property strTags The tags associated with the meal.
